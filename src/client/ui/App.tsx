...
/>`;
  ...
  return (
    <div className="App-embedModal-overlay" onClick={onClose}>
      <div
        className="App-embedModal"
        role="dialog"
        aria-modal="true"
        aria-label="Embed this example"
        onClick={(e: MouseEvent) => e.stopPropagation()}
      >
        <div className="App-embedModal-header">
          <h2 className="App-embedModal-title">Embed this example</h2>
          <button className="App-embedModal-closeBtn" onClick={onClose} aria-label="Close">
            &times;
          </button>
        </div>
